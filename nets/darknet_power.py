...
class CSPDarknet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.stem(x)
        jetson.close()
        print(f"stem:\t{jetson.stats['power cur']}")
        print(jetson.stats)
        outputs["stem"] = x
        ...
        x = self.dark2(x)
        jetson.close()
        print(f"dark2:\t{jetson.stats['power cur']}")
        outputs["dark2"] = x
        # -----------------------------------------------#
        ...
        x = self.dark3(x)
        jetson.close()
        print(f"dark3:\t{jetson.stats['power cur']}")
        outputs["dark3"] = x
        # -----------------------------------------------#
        ...
        x = self.dark4(x)
        jetson.close()
        print(f"dark4:\t{jetson.stats['power cur']}")
        outputs["dark4"] = x
        # -----------------------------------------------#
        ...
        x = self.dark5(x)
        jetson.close()
        print(f"dark5:\t{jetson.stats['power cur']}")
        outputs["dark5"] = x
